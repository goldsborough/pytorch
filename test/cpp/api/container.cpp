...
TEST_CASE("containers") {
  SECTION("conv") {
    SECTION("1d") {
      ...
      REQUIRE(model->parameters2().get("weight").grad().numel() == 3 * 2 * 3);
    }
    SECTION("2d") {
      SECTION("even") {
        ...
        REQUIRE(
            model->parameters2().get("weight").grad().numel() == 3 * 2 * 3 * 3);
      }
      ...
      SECTION("uneven") {
        ...
        REQUIRE(
            model->parameters2().get("weight").grad().numel() == 3 * 2 * 3 * 2);
      }
    }
    SECTION("3d") {
      ...
      REQUIRE(
          model->parameters2().get("weight").grad().numel() ==
          3 * 2 * 3 * 3 * 3);
    }
  }
  SECTION("linear") {
    SECTION("basic1") {
      ...
      REQUIRE(model->parameters2().get("weight").grad().numel() == 2 * 5);
    }
  ...
  SECTION("embedding") {
    SECTION("basic") {
      ...
      REQUIRE(
          model->parameters2().get("table").grad().numel() == 2 * dict_size);
    }
  ...
  SECTION("param") {
    ...
    auto parameters = model->parameters2();
