...
elseif(BLAS STREQUAL "MKL")
  ...
  if(MKL_FOUND)
    ...
    message(STATUS "MKL could not be found. Defaulting to Eigen")
    set(BLAS "Eigen" CACHE STRING "Selected BLAS library")
    set(CAFFE2_USE_EIGEN_FOR_BLAS ON)
  endif()
...
if(USE_NNPACK)
  ...
  if(NNPACK_FOUND)
    ...
    message(STATUS "Not compiling with NNPACK. Suppress this warning with -DUSE_NNPACK=OFF")
...
if(USE_LMDB)
  ...
  if(LMDB_FOUND)
    ...
    message(STATUS "Not compiling with LMDB. Suppress this warning with -DUSE_LMDB=OFF")
...
if(USE_LEVELDB)
  ...
  if(LEVELDB_FOUND AND SNAPPY_FOUND)
    ...
    message(STATUS "Not compiling with LevelDB. Suppress this warning with -DUSE_LEVELDB=OFF")
...
if(USE_NUMA)
  if(NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    message(STATUS "NUMA is currently only supported under Linux.")
    ...
    if(NUMA_FOUND)
      ...
      message(STATUS "Not compiling with NUMA. Suppress this warning with -DUSE_NUMA=OFF")
      caffe2_update_option(USE_NUMA OFF)
    endif()
  endif()
endif()
...
if(USE_ZMQ)
  ...
  if(ZMQ_FOUND)
    ...
    message(STATUS "Not compiling with ZMQ. Suppress this warning with -DUSE_ZMQ=OFF")
...
if(USE_REDIS)
  ...
  if(HIREDIS_FOUND)
    ...
    message(STATUS "Not compiling with Redis. Suppress this warning with -DUSE_REDIS=OFF")
...
if(USE_OPENCV)
  ...
  if(OpenCV_FOUND)
    ...
    message(STATUS "Not compiling with OpenCV. Suppress this warning with -DUSE_OPENCV=OFF")
...
if(BUILD_PYTHON)
  ...
  if(PYTHONINTERP_FOUND AND PYTHONLIBS_FOUND AND NUMPY_FOUND)
    ...
    message(STATUS "Python dependencies not met. Not compiling with python. Suppress this warning with -DBUILD_PYTHON=OFF")
  ...
  if(MPI_CXX_FOUND)
    ...
    if(OMPI_INFO)
      ...
      if(_output MATCHES "smcuda")
        ...
        message(STATUS "OpenMPI found, but it is not built with CUDA support.")
        set(CAFFE2_FORCE_FALLBACK_CUDA_MPI 1)
      endif()
    endif()
  else()
    message(STATUS "Not compiling with MPI. Suppress this warning with -DUSE_MPI=OFF")
...
if(USE_OPENMP)
  ...
  if(OPENMP_FOUND)
    ...
    message(STATUS "Not compiling with OpenMP. Suppress this warning with -DUSE_OPENMP=OFF")
...
if(USE_NCCL)
  ...
  elseif(NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    message(STATUS "NCCL is currently only supported under Linux.")
    caffe2_update_option(USE_NCCL OFF)
  else()
...
if(USE_GLOO)
  if(NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    message(STATUS "Gloo can only be used on Linux.")
    caffe2_update_option(USE_GLOO OFF)
  elseif(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
    message(STATUS "Gloo can only be used on 64-bit systems.")
    caffe2_update_option(USE_GLOO OFF)
  else()
...
if(USE_PROF)
  ...
  if(htrace_FOUND)
    ...
    message(STATUS "htrace not found. Caffe2 will build without htrace prof")
  endif()
endif()
...
if (USE_MOBILE_OPENGL)
  ...
  elseif (IOS)
    ...
    message(STATUS "mobile opengl is only used in android or ios builds.")
...
if (USE_ACL)
  if (NOT ANDROID)
    message(STATUS "ARM Compute Library is only supported for Android builds.")
    ...
    elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "^(arm64|aarch64)$")
      ...
      message(STATUS "ARM Compute Library is only supported for ARM/ARM64 builds.")
      caffe2_update_option(USE_ACL OFF)
    endif()
  endif()
endif()
...
if (USE_METAL)
  if (NOT IOS)
    message(STATUS "Metal is only used in ios builds.")
    caffe2_update_option(USE_METAL OFF)
  endif()
endif()

if (USE_NNAPI AND NOT ANDROID)
  message(STATUS "NNApi is only used in android builds.")
